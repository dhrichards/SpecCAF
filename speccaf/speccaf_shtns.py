...
class solver:
    ...
    def a4(self,f):
        ...
        a[:,0,0,0,0]=((0.2)+(0)*1j)*f[:,self.sh.idx(0,0)]+ ((-0.12777531299998798265)+(0)*1j)*f[:,self.sh.idx(2,0)]+ 2*((0.15649215928719031813)+(0)*1j)*f[:,self.sh.idx(2,2)]\
            + ((0.028571428571428571429)+(0)*1j)*f[:,self.sh.idx(4,0)]+ 2*((-0.030116930096841707924)+(0)*1j)*f[:,self.sh.idx(4,2)]+ 2*((0.039840953644479787999)+(0)*1j)*f[:,self.sh.idx(4,4)]
        
        a[:,1,0,0,0]=2*((0)+(0.078246079643595159065)*1j)*f[:,self.sh.idx(2,2)]+ 2*((0)+(-0.015058465048420853962)*1j)*f[:,self.sh.idx(4,2)]+ 2*((0)+(0.039840953644479787999)*1j)*f[:,self.sh.idx(4,4)]
        a[:,0,1,0,0]=a[:,1,0,0,0]
        a[:,0,0,1,0]=a[:,1,0,0,0]
        a[:,0,0,0,1]=a[:,1,0,0,0]
        
        a[:,2,0,0,0]=2*((-0.078246079643595159065)+(0)*1j)*f[:,self.sh.idx(2,1)]+ 2*((0.031943828249996995663)+(0)*1j)*f[:,self.sh.idx(4,1)]+ 2*((-0.028171808490950552584)+(0)*1j)*f[:,self.sh.idx(4,3)]
        a[:,0,2,0,0]=a[:,2,0,0,0]
        a[:,0,0,2,0]=a[:,2,0,0,0]
        a[:,0,0,0,2]=a[:,2,0,0,0]
        
        a[:,1,1,0,0]=((0.066666666666666666667)+(0)*1j)*f[:,self.sh.idx(0,0)]+ ((-0.042591770999995994217)+(0)*1j)*f[:,self.sh.idx(2,0)]+ ((0.0095238095238095238095)+(0)*1j)*f[:,self.sh.idx(4,0)]+ 2*((-0.039840953644479787999)+(0)*1j)*f[:,self.sh.idx(4,4)]
        a[:,1,0,1,0]=a[:,1,1,0,0]
        a[:,1,0,0,1]=a[:,1,1,0,0]
        a[:,0,1,1,0]=a[:,1,1,0,0]
        a[:,0,1,0,1]=a[:,1,1,0,0]
        ...
        a[:,2,1,0,0]=2*((0)+(-0.026082026547865053022)*1j)*f[:,self.sh.idx(2,1)]+ 2*((0)+(0.010647942749998998554)*1j)*f[:,self.sh.idx(4,1)]+ 2*((0)+(-0.028171808490950552584)*1j)*f[:,self.sh.idx(4,3)]
        a[:,2,0,1,0]=a[:,2,1,0,0]
        a[:,2,0,0,1]=a[:,2,1,0,0]
        a[:,1,2,0,0]=a[:,2,1,0,0]
        a[:,1,0,2,0]=a[:,2,1,0,0]
        ...
        a[:,2,2,0,0]=((0.066666666666666666667)+(0)*1j)*f[:,self.sh.idx(0,0)]+ ((0.021295885499997997109)+(0)*1j)*f[:,self.sh.idx(2,0)]+ 2*((0.026082026547865053022)+(0)*1j)*f[:,self.sh.idx(2,2)]\
            + ((-0.038095238095238095238)+(0)*1j)*f[:,self.sh.idx(4,0)]+ 2*((0.030116930096841707924)+(0)*1j)*f[:,self.sh.idx(4,2)]
        a[:,2,0,2,0]=a[:,2,2,0,0]
        a[:,2,0,0,2]=a[:,2,2,0,0]
        a[:,0,2,2,0]=a[:,2,2,0,0]
        a[:,0,2,0,2]=a[:,2,2,0,0]
        ...
        a[:,1,1,1,0]=2*((0)+(0.078246079643595159065)*1j)*f[:,self.sh.idx(2,2)]+ 2*((0)+(-0.015058465048420853962)*1j)*f[:,self.sh.idx(4,2)]+ 2*((0)+(-0.039840953644479787999)*1j)*f[:,self.sh.idx(4,4)]
        a[:,1,1,0,1]=a[:,1,1,1,0]
        a[:,1,0,1,1]=a[:,1,1,1,0]
        a[:,0,1,1,1]=a[:,1,1,1,0]
        
        a[:,2,1,1,0]=2*((-0.026082026547865053022)+(0)*1j)*f[:,self.sh.idx(2,1)]+ 2*((0.010647942749998998554)+(0)*1j)*f[:,self.sh.idx(4,1)]+ 2*((0.028171808490950552584)+(0)*1j)*f[:,self.sh.idx(4,3)]
        a[:,2,1,0,1]=a[:,2,1,1,0]
        a[:,2,0,1,1]=a[:,2,1,1,0]
        a[:,1,2,1,0]=a[:,2,1,1,0]
        a[:,1,2,0,1]=a[:,2,1,1,0]
        ...
        a[:,2,2,1,0]=2*((0)+(0.026082026547865053022)*1j)*f[:,self.sh.idx(2,2)]+ 2*((0)+(0.030116930096841707924)*1j)*f[:,self.sh.idx(4,2)]
        a[:,2,2,0,1]=a[:,2,2,1,0]
        a[:,2,1,2,0]=a[:,2,2,1,0]
        a[:,2,1,0,2]=a[:,2,2,1,0]
        a[:,2,0,2,1]=a[:,2,2,1,0]
        ...
        a[:,2,2,2,0]=2*((-0.078246079643595159065)+(0)*1j)*f[:,self.sh.idx(2,1)]+ 2*((-0.042591770999995994217)+(0)*1j)*f[:,self.sh.idx(4,1)]
        a[:,2,2,0,2]=a[:,2,2,2,0]
        a[:,2,0,2,2]=a[:,2,2,2,0]
        a[:,0,2,2,2]=a[:,2,2,2,0]
        
        a[:,1,1,1,1]=((0.2)+(0)*1j)*f[:,self.sh.idx(0,0)]+ ((-0.12777531299998798265)+(0)*1j)*f[:,self.sh.idx(2,0)]+ 2*((-0.15649215928719031813)+(0)*1j)*f[:,self.sh.idx(2,2)]\
            + ((0.028571428571428571429)+(0)*1j)*f[:,self.sh.idx(4,0)]+ 2*((0.030116930096841707924)+(0)*1j)*f[:,self.sh.idx(4,2)]+ 2*((0.039840953644479787999)+(0)*1j)*f[:,self.sh.idx(4,4)]
        
        a[:,2,1,1,1]=2*((0)+(-0.078246079643595159065)*1j)*f[:,self.sh.idx(2,1)]+ 2*((0)+(0.031943828249996995663)*1j)*f[:,self.sh.idx(4,1)]+ 2*((0)+(0.028171808490950552584)*1j)*f[:,self.sh.idx(4,3)]
        a[:,1,2,1,1]=a[:,2,1,1,1]
        a[:,1,1,2,1]=a[:,2,1,1,1]
        a[:,1,1,1,2]=a[:,2,1,1,1]
        
        a[:,2,2,1,1]=((0.066666666666666666667)+(0)*1j)*f[:,self.sh.idx(0,0)]+ ((0.021295885499997997109)+(0)*1j)*f[:,self.sh.idx(2,0)]+ 2*((-0.026082026547865053022)+(0)*1j)*f[:,self.sh.idx(2,2)]+ ((-0.038095238095238095238)+(0)*1j)*f[:,self.sh.idx(4,0)]+ 2*((-0.030116930096841707924)+(0)*1j)*f[:,self.sh.idx(4,2)]
        a[:,2,1,2,1]=a[:,2,2,1,1]
        a[:,2,1,1,2]=a[:,2,2,1,1]
        a[:,1,2,2,1]=a[:,2,2,1,1]
        a[:,1,2,1,2]=a[:,2,2,1,1]
        ...
        a[:,2,2,2,1]=2*((0)+(-0.078246079643595159065)*1j)*f[:,self.sh.idx(2,1)]+ 2*((0)+(-0.042591770999995994217)*1j)*f[:,self.sh.idx(4,1)]
        a[:,2,2,1,2]=a[:,2,2,2,1]
        a[:,2,1,2,2]=a[:,2,2,2,1]
        a[:,1,2,2,2]=a[:,2,2,2,1]
        
        a[:,2,2,2,2]=((0.2)+(0)*1j)*f[:,self.sh.idx(0,0)]+ ((0.2555506259999759653)+(0)*1j)*f[:,self.sh.idx(2,0)]+ ((0.076190476190476190476)+(0)*1j)*f[:,self.sh.idx(4,0)]
